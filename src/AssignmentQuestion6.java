...
public class AssignmentQuestion6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("50% discount on all products, so you will get a discount of: " + dollar
				+ (discountEvery * productPrice));

		if (promo5) {
			System.out.println("Additional Promo5 is applied, so the price is: " + dollar
					+ (productPrice - (productPrice * (discount5 + discountEvery))));
		} else if (promo10) {
			System.out.println("Additional Promo10 is applied, so the price is: " + dollar
					+ (productPrice - (productPrice * (discount10 + discountEvery))));
		} else if (promo20) {
			System.out.println("Additional Promo20 is applied, so the price is: " + dollar
